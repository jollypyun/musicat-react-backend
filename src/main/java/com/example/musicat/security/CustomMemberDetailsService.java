...
public class CustomMemberDetailsService implements UserDetailsService {
    ...
    //UserDetails 타입으로 member 정보 반환해야 함(Session > speing session > authenticate 객체 안에 들어갈 수 있는 타입은 2가지
...
//        }
        ...
        log.info("loadUserByUsername memberVo email, pwd : " + memberVo.getEmail() + ", " + memberVo.getPassword());
